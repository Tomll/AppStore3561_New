...
// 建议加上注解， 混淆后表名不受影响
public class APPSearch implements Serializable,Parcelable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1341139868789327619L;
	...
	public APPSearch(Parcel source) {
	...
	public static final Parcelable.Creator<APPSearch> CREATOR = new Creator<APPSearch>() {

		@Override
		public APPSearch createFromParcel(Parcel source) {
			return new APPSearch(source);
		}

		@Override
		public APPSearch[] newArray(int size) {
			return new APPSearch[size];
		} 
	};
