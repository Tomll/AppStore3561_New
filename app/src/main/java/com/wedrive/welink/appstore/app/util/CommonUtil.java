...
/*	public static int getAPILevel(Context context) {
	...
	public static void writeTxtToFile(String strcontent) {
		...
		String strFilePath = path.toString() + "/Test/appstore_log2.txt";
		...
		try {
			...
			raf.write((LogManager.TIME_FORMAT.format(new Date()) + "::" + strContent)
					.getBytes());
			raf.close();
	...
	* @date 2016年5月9日
	...
	public static String chooseUriToPackageName(String packageName){		
		...
		if("com.itings.myradio.siwei.book".equalsIgnoreCase(packageName))
			...
			uri = "wedrive.iqiyi:";
		else if("com.youku.phone.tuba".equalsIgnoreCase(packageName))
			uri = "wedrive.youku:";
		return uri;
	}
