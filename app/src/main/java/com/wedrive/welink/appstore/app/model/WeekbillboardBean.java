...
/**
 * @author jiaoyb 类描述：飙升榜 javaBean
 */
@Table(name = "WeekbillboardBean")
// 建议加上注解， 混淆后表名不受影响
public class WeekbillboardBean implements Serializable, Parcelable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4740955470229236733L;
	@Id(column = "app_id")
	...
	public WeekbillboardBean() {
		super();
	}

	public WeekbillboardBean(Parcel source) {
	...
	public boolean equals(Object o) {
		WeekbillboardBean version = (WeekbillboardBean) o;
	...
	public static final Parcelable.Creator<WeekbillboardBean> CREATOR = new Creator<WeekbillboardBean>() {

		@Override
		public WeekbillboardBean createFromParcel(Parcel source) {
			return new WeekbillboardBean(source);
		}

		@Override
		public WeekbillboardBean[] newArray(int size) {
			return new WeekbillboardBean[size];
		}
	};
